...
namespace Calculate.Models
{
    public class Initial
    {
        ...
        bool Calculate(string user_id, string DeptId, string StudentId, int Secno, int Grade, int Clacod, int syearEnd, int semEnd, bool Isrank, string connectionString)
        {
            bool rank_cd = true;
            List<RegSem> regsems = new List<RegSem>();
            if (DeptId != null) //dept
            ...
            rank_cd = selstchf.CheckSelstchf(user_id, students, regsems, Isrank, connectionString) && rank_cd;
            selstugracrd.CheckSelstugracrd(user_id, students, regsems, Isrank, rank_cd, connectionString);
            return true;
        }

        public bool Init(JSON JsonObject, string connectionString)
        {
            ...
            return Calculate(user_id, DeptId, StudentId, Secno, Grade, Clacod, syearEnd, semEnd, Isrank, connectionString);
        }
    }
}